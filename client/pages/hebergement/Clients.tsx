        ...
        <Paper sx={{ p:2 }}>
          ...
          <List dense>
            {list.map(c=> {
              ...
              const type = hist.length? 'Particulier':'Société';
              return (
          ...
          {selected && (
            <Stack spacing={1}>
              ...
              <Stack direction={{ xs:'column', md:'row' }} spacing={1}>
                ...
                <TextField size="small" label="Type" defaultValue={history.length? 'Particulier':'Société'} />
              </Stack>
              <Stack direction={{ xs:'column', md:'row' }} spacing={1}>
              ...
              <Box sx={{ mt:1 }}>
                <Typography fontWeight={700} mb={1}>Historique</Typography>
                {history.map(h => (
